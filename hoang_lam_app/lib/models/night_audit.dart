...
sealed class NightAudit with _$NightAudit {
  ...
  const factory NightAudit({
    ...
    @JsonKey(name: 'occupancy_rate') @Default(0) double occupancyRate,
    // Booking statistics
    ...
    @JsonKey(name: 'room_revenue') @Default(0) double roomRevenue,
    @JsonKey(name: 'other_revenue') @Default(0) double otherRevenue,
    @JsonKey(name: 'total_expense') @Default(0) double totalExpense,
    @JsonKey(name: 'net_revenue') @Default(0) double netRevenue,
    // Payment breakdown
    @JsonKey(name: 'cash_collected') @Default(0) double cashCollected,
    @JsonKey(name: 'bank_transfer_collected') @Default(0) double bankTransferCollected,
    @JsonKey(name: 'momo_collected') @Default(0) double momoCollected,
    @JsonKey(name: 'other_payments') @Default(0) double otherPayments,
    // Outstanding
