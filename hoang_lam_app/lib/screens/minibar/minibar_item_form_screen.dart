...
class _MinibarItemFormScreenState extends ConsumerState<MinibarItemFormScreen> {
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    categoriesAsync.when(
                      data:
                          (categories) => Autocomplete<String>(
                    ...
                    SwitchListTile(
                      ...
                      subtitle: Text(
                        _isActive ? l10n.activeSelling : l10n.inactiveSelling,
                      ),
                      value: _isActive,
                    ...
                    FilledButton(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(AppSpacing.md),
                        child: Text(
                          _isEditing ? l10n.updateLabel : l10n.addProduct,
                        ),
                      ),
                    ),
                  ],
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              _isEditing ? l10n.productUpdatedSuccess : l10n.productAddedMsg,
            ),
  ...
  Future<void> _confirmDelete() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(
              '${l10n.confirmDeleteProductMsg} "${widget.item!.name}"?',
            ),
            actions: [
              TextButton(
    ...
    try {
      await ref.read(minibarProvider.notifier).deleteItem(widget.item!.id);
      ref.invalidate(minibarItemsProvider);
