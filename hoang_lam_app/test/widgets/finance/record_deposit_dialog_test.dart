  ...
  group('RecordDepositDialog', () {
    ...
    testWidgets('displays both room and guest when provided', (tester) async {
      await tester.pumpWidget(
        buildTestWidget(roomNumber: '102', guestName: 'Trần Văn B'),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('does not pre-fill when suggestedAmount is null', (
      tester,
    ) async {
    ...
    testWidgets('does not pre-fill when suggestedAmount is zero', (
      tester,
    ) async {
