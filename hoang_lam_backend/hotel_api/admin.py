...
from .models import (
    RoomType, Room, Booking, FinancialCategory, FinancialEntry,
    HotelUser, Housekeeping, MinibarItem, MinibarSale, ExchangeRate
)
...
class BookingAdmin(admin.ModelAdmin):
    list_display = [
        'room', 'guest_name', 'check_in_date', 'check_out_date',
        'status', 'source', 'total_amount', 'is_paid'
    ]
