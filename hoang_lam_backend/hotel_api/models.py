...
class Booking(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        related_name='created_bookings', verbose_name='Người tạo'
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class FinancialEntry(models.Model):
    ...
    category = models.ForeignKey(
        FinancialCategory, on_delete=models.PROTECT,
    ...
    booking = models.ForeignKey(
        ...
        related_name='financial_entries', verbose_name='Đặt phòng liên quan'
    )

    # Payment
    payment_method = models.CharField(
        max_length=20, choices=Booking.PaymentMethod.choices,
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True,
        related_name='created_entries', verbose_name='Người tạo'
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Housekeeping(models.Model):
    ...
    assigned_to = models.ForeignKey(
        ...
        related_name='assigned_housekeeping', verbose_name='Phân công cho'
    )
    notes = models.TextField(blank=True, verbose_name='Ghi chú')
    ...
    booking = models.ForeignKey(
        Booking, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='housekeeping_tasks', verbose_name='Đặt phòng liên quan'
    )

    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True,
        related_name='created_housekeeping', verbose_name='Người tạo'
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class MinibarSale(models.Model):
    ...
    booking = models.ForeignKey(
        Booking, on_delete=models.CASCADE, related_name='minibar_sales',
        verbose_name='Đặt phòng'
    )
    item = models.ForeignKey(
        MinibarItem, on_delete=models.PROTECT, related_name='sales',
